...
`], ...formatTraceEntry(entry));
  ...
  */
        ...
        return openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("main", _hoisted_1, [
            createBaseVNode("div", {
              ...
              _cache[4] || (_cache[4] = createStaticVNode('<h1 class="section-title" data-v-c583092a>get to know <span class="gradient-text" data-v-c583092a>[not really]</span> me</h1><p class="section-description" data-v-c583092a>This is an AI tool I built that can answer questions about my experience, work, interests, and who knows what else. Hopefully not my security questions.</p><p class="section-description tech-item" data-v-c583092a>→For design and dev, I used Figma with the MCP server protocol, Cursor, and Claude Code.</p><p class="section-description tech-item" data-v-c583092a>→For the LLM, I used the Claude API and an extensive context doc along with Github and Vercel for deployment.</p><p class="section-description tech-item" data-v-c583092a>→The last step was creating a standalone Vue component embedded into my Webflow site.</p><p class="section-description" data-v-c583092a>Want to hear more about how it was built? Check out the first suggested question down below ↓</p>', 6)),
            ...
            showLoading.value ? (openBlock(), createElementBlock("div", {
              ...
              _cache[5] || (_cache[5] = createStaticVNode('<svg class="loading-spinner" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" data-v-c583092a><defs data-v-c583092a><radialGradient id="fogGradient1" cx="30%" cy="30%" data-v-c583092a><stop offset="0%" stop-color="rgba(255, 255, 255, 0.15)" data-v-c583092a></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.05)" data-v-c583092a></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-c583092a></stop></radialGradient><radialGradient id="fogGradient2" cx="70%" cy="60%" data-v-c583092a><stop offset="0%" stop-color="rgba(252, 243, 234, 0.12)" data-v-c583092a></stop><stop offset="60%" stop-color="rgba(252, 243, 234, 0.03)" data-v-c583092a></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-c583092a></stop></radialGradient><radialGradient id="fogGradient3" cx="50%" cy="80%" data-v-c583092a><stop offset="0%" stop-color="rgba(255, 255, 255, 0.1)" data-v-c583092a></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.02)" data-v-c583092a></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-c583092a></stop></radialGradient><radialGradient id="centerGlow" data-v-c583092a><stop offset="0%" stop-color="rgba(255, 255, 255, 0.12)" data-v-c583092a></stop><stop offset="70%" stop-color="rgba(255, 255, 255, 0)" data-v-c583092a></stop></radialGradient><filter id="glow" data-v-c583092a><feGaussianBlur stdDeviation="2" result="coloredBlur" data-v-c583092a></feGaussianBlur><feMerge data-v-c583092a><feMergeNode in="coloredBlur" data-v-c583092a></feMergeNode><feMergeNode in="SourceGraphic" data-v-c583092a></feMergeNode></feMerge></filter></defs><circle cx="60" cy="60" r="55" fill="url(#fogGradient1)" class="fog-layer-1" data-v-c583092a></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient2)" class="fog-layer-2" data-v-c583092a></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient3)" class="fog-layer-3" data-v-c583092a></circle><circle cx="60" cy="60" r="40" fill="url(#centerGlow)" class="center-glow" filter="url(#glow)" data-v-c583092a></circle></svg>', 1)),
  ...
  const JeremyChatWidget2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c583092a"]]);
