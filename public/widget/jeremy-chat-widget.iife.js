...
`], ...formatTraceEntry(entry));
  ...
  */
  ...
  const _sfc_main = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
      ...
      const suggestedQueries = [
        ...
        "Are you making up information at all?",
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("main", _hoisted_2, [
              ...
              showLoading.value ? (openBlock(), createElementBlock("div", {
                ...
                _cache[4] || (_cache[4] = createStaticVNode('<svg class="loading-spinner" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" data-v-eec1ecfa><defs data-v-eec1ecfa><radialGradient id="fogGradient1" cx="30%" cy="30%" data-v-eec1ecfa><stop offset="0%" stop-color="rgba(255, 255, 255, 0.15)" data-v-eec1ecfa></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.05)" data-v-eec1ecfa></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-eec1ecfa></stop></radialGradient><radialGradient id="fogGradient2" cx="70%" cy="60%" data-v-eec1ecfa><stop offset="0%" stop-color="rgba(252, 243, 234, 0.12)" data-v-eec1ecfa></stop><stop offset="60%" stop-color="rgba(252, 243, 234, 0.03)" data-v-eec1ecfa></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-eec1ecfa></stop></radialGradient><radialGradient id="fogGradient3" cx="50%" cy="80%" data-v-eec1ecfa><stop offset="0%" stop-color="rgba(255, 255, 255, 0.1)" data-v-eec1ecfa></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.02)" data-v-eec1ecfa></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-eec1ecfa></stop></radialGradient><radialGradient id="centerGlow" data-v-eec1ecfa><stop offset="0%" stop-color="rgba(255, 255, 255, 0.12)" data-v-eec1ecfa></stop><stop offset="70%" stop-color="rgba(255, 255, 255, 0)" data-v-eec1ecfa></stop></radialGradient><filter id="glow" data-v-eec1ecfa><feGaussianBlur stdDeviation="2" result="coloredBlur" data-v-eec1ecfa></feGaussianBlur><feMerge data-v-eec1ecfa><feMergeNode in="coloredBlur" data-v-eec1ecfa></feMergeNode><feMergeNode in="SourceGraphic" data-v-eec1ecfa></feMergeNode></feMerge></filter></defs><circle cx="60" cy="60" r="55" fill="url(#fogGradient1)" class="fog-layer-1" data-v-eec1ecfa></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient2)" class="fog-layer-2" data-v-eec1ecfa></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient3)" class="fog-layer-3" data-v-eec1ecfa></circle><circle cx="60" cy="60" r="40" fill="url(#centerGlow)" class="center-glow" filter="url(#glow)" data-v-eec1ecfa></circle></svg>', 1)),
  ...
  const JeremyChatWidget2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eec1ecfa"]]);
